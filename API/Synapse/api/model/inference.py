...
class Model:
    ...
    def predict_from_image(self, image_file):
        ...
        image_array = np.expand_dims(image_array, axis=0)  # Menjadi (1, 224, 224, 3)
        ...
        if self.model_type == "keras":
            ...
            # Mapping dari label asli ke label baru
            label_mapping = {
                "dark": "Hitam",
                "light": "Putih",
                "lighten": "Putih",
                "mid dark": "Sawo Matang",
                "mid light": "Kuning Langsat",
                "mid-dark": "Sawo Matang",
                "mid-light": "Kuning Langsat",
            }

            prediction = self.model.predict(image_array)
            predicted_label_original = original_labels[np.argmax(prediction)]
            predicted_label_new = label_mapping[predicted_label_original]
            return predicted_label_new
            ...
            raise ValueError(
                "This method is only supported for Keras and TensorFlow Lite models."
            )
